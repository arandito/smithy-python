...
public final class SetupGenerator {
    ...
    /**
     * Write the files required for MkDocs documentation generation
     */
    private static void writeDocsSkeleton(
            PythonSettings settings,
            GenerationContext context
    ) {
        //TODO: Add a flag to disable the generation of the Mkdocs files
        ...
        writeMkDocsConfig(settings, context, projectName);
