...
from .client import ContainerMetadataClient, ContainerMetadataConfig
...
class ContainerCredentialsResolver(
    ...
    def __init__(
        ...
        config: ContainerMetadataConfig | None = None,
    ):
        self._http_client = http_client
        self._config = config or ContainerMetadataConfig()
